...
List<BookStatusdbo> bookstatus= new ArrayList<>();
	...
	public void updateMember(Integer bookCode, BookStatusdbo regdbo) throws LibrarianException {
		Optional<BookStatus> customer = bookStatusRepository.findById(bookCode);
		BookStatus c = customer.orElseThrow(() -> new LibrarianException("Service.BOOKID_NOT_FOUND"));
		bookStatusRepository.save(c);
	}
}
